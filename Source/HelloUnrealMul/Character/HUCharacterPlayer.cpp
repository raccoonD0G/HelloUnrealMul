...
AHUCharacterPlayer::AHUCharacterPlayer()
{
	// Camera
...
void AHUCharacterPlayer::BeginPlay()
{
	Super::BeginPlay();
...
void AHUCharacterPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AHUCharacterPlayer::Move);
	EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AHUCharacterPlayer::Look);
}

void AHUCharacterPlayer::Move(const FInputActionValue& Value)
{
...
void AHUCharacterPlayer::Look(const FInputActionValue& Value)
{
